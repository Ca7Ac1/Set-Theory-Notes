...
\begin{exer}
    ...
    \begin{answer}
        % Taking an infinite binary sequence and prepending it with two $0$'s gives us an injection from $2^{\aleph_0}$ to $\prod_{n \in \omega} n$. We can also take an infinite sequence where each element is bounded by its index and represent each element in binary, appending $0$'s until there are enough digits to represent every number up to the index. Such a mapping is an injection from $prod_{n \in \omega} n$ to $2^{\aleph_0}$. Thus such sets are equal as cardinals.
...
\begin{exer}
    ...
    % \begin{answer}
    %     \[
    %         \aleph_{\omega_1 + \omega}^{\aleph_1}
    %         =
    %         (\bigcup_{n < \omega} \aleph_{\omega_1 + n})^{\aleph_1}
    %         \le 
    %         (\prod_{n < \omega} \aleph_{\omega_1 + n})^{\aleph_1}
    %         =
    %         \prod_{n < \omega} \aleph_{\omega_1 + n}^{\aleph_1}
    %     \]
    % \end{answer}
...
\begin{exer}
    ...
    \begin{answer}
        % We have that $\aleph_{\alpha}^{\aleph_0} \cdot 2^{\aleph_1} = \max(\aleph_{\alpha}^{\aleph_0}, 2^{\aleph_1}) \le \aleph_{\alpha}^{\aleph_1}$. In the case $2^{\aleph_1} \ge \aleph_{\alpha}$ we have $\aleph_{\alpha}^{\aleph_1} \le (2^{\aleph_1})^{\aleph_1} = 2^{\aleph_1}$ which implies $\aleph_{\alpha}^{\aleph_1} = \aleph_{\alpha}^{\aleph_0} \cdot 2^{\aleph_1}$. Let us consider if $2^{\aleph_1} < \aleph_{\alpha}$. We then have
        % \[
        %     \aleph_{\alpha}^{\aleph_1} = 
        %     (\sup_{\gamma \in \alpha} \aleph_\gamma)^{\aleph_1}
        %     \le
        %     (\prod_{\gamma \in \alpha} \aleph_\gamma)^{\aleph_1}
        %     = 
        %     \prod_{\gamma \in \alpha} \aleph_{\gamma}^{\aleph_1}
        % \]
        % We have that $\aleph_{0}^{\aleph_1} = 2^{\aleph_1} < \aleph_{\omega}$. Let us induct on $\gamma$. Assuming $\aleph_{\gamma}^{\aleph_1} < \aleph_{\alpha}$ we have by 5.36 
        % \[
        %     \aleph_{\gamma + 1}^{\aleph_1} 
        %     =
        %     \aleph_{\gamma}^{\aleph_1} \cdot \aleph_{\gamma + 1}
        %     < 
        %     \aleph_{\alpha}
        % \]
        % Thus we have $\prod_{n \in \omega} \aleph_{n}^{\aleph_1} \le \prod_{n \in \omega} \aleph_\omega = \aleph_{\omega}^{\aleph_1}$. Therefore $\aleph_{\omega}^{\aleph_1}$.
